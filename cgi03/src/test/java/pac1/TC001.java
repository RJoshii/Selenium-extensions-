...
public class TC001 {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//*[@id='input-firstname']")).sendKeys("RASHMI");
        driver.findElement(By.xpath("//*[@id='input-lastname']")).sendKeys("JOSHI");
        driver.findElement(By.xpath("//*[@id='input-email']")).sendKeys("rashii22544@gmail.com");
